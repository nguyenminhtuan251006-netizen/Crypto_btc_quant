...
class BinanceFuturesEngine:
    def __init__(
        ...
        fee_rate: float = 0.0004,             # 0.04% per side (Maker/Taker blend on Binance Futures)
        stop_loss_pct: float = 0.006,         # 0.6% stop loss on BTC price
        take_profit_pct: float = 0.012        # 1.2% take profit on BTC price (2:1 Risk/Reward)
    ):
